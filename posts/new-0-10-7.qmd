...
This behavior has been updated in more recent mrgsolve versions. 
mrgsolve will now generate an error when a parameter is in the data
set but it is not numeric. 
