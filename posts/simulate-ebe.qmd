...
date: 4/23/2022
description: > 
  This blog post will show you how to use a single model to do both  population 
  simulation  and simulation from a specific set of empirical Bayes estimates. 
  The basic implementation for this approach was pioneered by Tim Waterhouse
  at MetrumRG.
---
