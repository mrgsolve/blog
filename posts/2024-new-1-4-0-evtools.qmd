...
```{r, code = readLines("evtools-1.mod"), eval = FALSE}
...
```{r, code = readLines("evtools-2.mod"), eval = FALSE}
...
```{r, code = readLines("evtools-3.mod"), eval = FALSE}
...
```{r, code = readLines("evtools-4.mod"), eval = FALSE}
...
```{r, code = readLines("evtools-5.mod"), eval = FALSE}
